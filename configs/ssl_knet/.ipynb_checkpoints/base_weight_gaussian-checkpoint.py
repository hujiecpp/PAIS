_base_ = [
    ...
    '../_base_/models/knet_s3_r50_fpn_weight.py',
...
evaluation = dict(type="SubModulesDistEvalHook", interval=800000)
...
checkpoint_config = dict(by_epoch=False, interval=8000, max_keep_ckpts=30)
