...
custom_imports = dict(
    imports=[
        'ssod.knet_bg.det.knet',
        'ssod.knet_bg.det.kernel_head',
        'ssod.knet_bg.det.kernel_iter_head',
        'ssod.knet_bg.det.kernel_update_head',
        'ssod.knet_bg.det.semantic_fpn_wrapper',
        'ssod.knet_bg.kernel_updator',
        'ssod.knet_bg.det.mask_hungarian_assigner',
        'ssod.knet_bg.det.mask_pseudo_sampler',
    ],
