...
custom_imports = dict(
    imports=[
        'ssod.knet_withiou_weight_multi_iou.det.knet',
        'ssod.knet_withiou_weight_multi_iou.det.kernel_head',
        'ssod.knet_withiou_weight_multi_iou.det.kernel_iter_head',
        'ssod.knet_withiou_weight_multi_iou.det.kernel_update_head',
        'ssod.knet_withiou_weight_multi_iou.det.semantic_fpn_wrapper',
        'ssod.knet_withiou_weight_multi_iou.kernel_updator',
        'ssod.knet_withiou_weight_multi_iou.det.mask_hungarian_assigner',
        'ssod.knet_withiou_weight_multi_iou.det.mask_pseudo_sampler',
    ],
