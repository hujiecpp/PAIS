...
custom_imports = dict(
    imports=[
        'ssod.knet_withiou_weight_test.det.knet',
        'ssod.knet_withiou_weight_test.det.kernel_head',
        'ssod.knet_withiou_weight_test.det.kernel_iter_head',
        'ssod.knet_withiou_weight_test.det.kernel_update_head',
        'ssod.knet_withiou_weight_test.det.semantic_fpn_wrapper',
        'ssod.knet_withiou_weight_test.kernel_updator',
        'ssod.knet_withiou_weight_test.det.mask_hungarian_assigner',
        'ssod.knet_withiou_weight_test.det.mask_pseudo_sampler',
    ],
