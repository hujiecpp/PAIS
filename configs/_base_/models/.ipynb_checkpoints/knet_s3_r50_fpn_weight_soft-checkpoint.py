...
custom_imports = dict(
    imports=[
        'ssod.knet_withiou_weight_soft.det.knet',
        'ssod.knet_withiou_weight_soft.det.kernel_head',
        'ssod.knet_withiou_weight_soft.det.kernel_iter_head',
        'ssod.knet_withiou_weight_soft.det.kernel_update_head',
        'ssod.knet_withiou_weight_soft.det.semantic_fpn_wrapper',
        'ssod.knet_withiou_weight_soft.kernel_updator',
        'ssod.knet_withiou_weight_soft.det.mask_hungarian_assigner',
        'ssod.knet_withiou_weight_soft.det.mask_pseudo_sampler',
    ],
