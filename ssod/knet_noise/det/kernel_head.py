...
#根据loss大小随机去掉一些loss，仅用于无标签图片
            ...
            if flag == 0:
                ...
                #print("loss_rpn_mask", loss_rpn_mask)
                ...
                print("dense_head"+"="*50)
                print("loss_rpn_mask", loss_rpn_mask)
                print("loss_rpn_dice", loss_rpn_dice)
                '''
                losses['loss_rpn_mask'] = loss_mask(final_pos_mask_pred,
                                                         final_pos_mask_targets)

                final_pos_mask_pred_1 =  pos_mask_pred[index_1]
                final_pos_mask_targets_1 = pos_mask_targets[index_1]            

                losses['loss_rpn_dice'] = self.loss_dice(final_pos_mask_pred_1,
