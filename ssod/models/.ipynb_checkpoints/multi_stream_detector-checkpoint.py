...
#-----------------------------------#
        #print("+"*100)
        #print(self.inference_on) #student
    ...
    def freeze(self, model_ref: str):
        ...
        model = getattr(self, model_ref)     #获取该属性对应的子模型
        model.eval()
    ...
    def simple_test(self, img, img_metas, **kwargs):
        #print(self.model(**kwargs).simple_test(img, img_metas, **kwargs))
