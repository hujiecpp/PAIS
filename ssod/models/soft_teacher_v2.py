...
class SoftTeacher_wo_jit(MultiSteamDetector):
    def __init__(self, model: dict, train_cfg=None, test_cfg=None):
        super(SoftTeacher_wo_jit, self).__init__(
...
#！具体修改————增加mask分支-----------------------------------#
        ...
        det_masks = self.teacher.roi_head.simple_test_mask_1(
